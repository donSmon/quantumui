        ...
        this.$get = [
          ...
          function ($filter, $window, $http, $compile, $rootScope, $popMaster, $parseOptions, $timeout, $q, $scrollbar, $lazyRequest, $helpers, $parse) {
              ...
              function SelectFactory(element, controller, config, attr, targetEl) {
                  ...
                  var searchInput = angular.element(['<input ' + id + 'ng-hide="$hideFilter" no-validate="true" ng-model="filterModel.label" type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="{{$placeholder}}" class="select-input form-control" role="combobox" aria-expanded="true"',
                  ...
                  $select.loadRemote = function (term, data) {
                      ...
                      var post = (data && !term && (data.length  || angular.isObject(data))) ? true : false;
